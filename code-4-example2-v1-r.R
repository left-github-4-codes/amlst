...
#revision (corrected a typo) on 04/20/24 for tas by Y. Zuo
...
EMSE_aa2=sum(beta_aa2*beta_aa2)/R
EMSE_aa3=sum(beta_aa3*beta_aa3)/R
EMSE_aa4=sum(beta_aa4*beta_aa4)/R  #revised on 4/20/24 by Y. Zuo (3->4)on RHS
...
SS_aa4=beta_aa4*beta_aa4 #revised on 4/20/24 by Y. Zuo (3->4)on RHS
